...
class WidgettypecontrollerApi(object):
    ...
    def delete_widget_type_using_delete(self, widget_type_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_widget_type_using_delete(widget_type_id, callback=callback_function)
    ...
    def delete_widget_type_using_delete_with_http_info(self, widget_type_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_widget_type_using_delete_with_http_info(widget_type_id, callback=callback_function)
        ...
        resource_path = '/api/widgetType/{widgetTypeId}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_bundle_widget_types_using_get(self, is_system, bundle_alias, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_bundle_widget_types_using_get(is_system, bundle_alias, callback=callback_function)
    ...
    def get_bundle_widget_types_using_get_with_http_info(self, is_system, bundle_alias, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_bundle_widget_types_using_get_with_http_info(is_system, bundle_alias, callback=callback_function)
        ...
        resource_path = '/api/widgetTypes'.replace('{format}', 'json')
        path_params = {}

        query_params = {}
        if 'is_system' in params:
            query_params['isSystem'] = params['is_system']
        if 'bundle_alias' in params:
            query_params['bundleAlias'] = params['bundle_alias']
    ...
    def get_widget_type_by_id_using_get(self, widget_type_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_widget_type_by_id_using_get(widget_type_id, callback=callback_function)
    ...
    def get_widget_type_by_id_using_get_with_http_info(self, widget_type_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_widget_type_by_id_using_get_with_http_info(widget_type_id, callback=callback_function)
    ...
    def get_widget_type_using_get(self, is_system, bundle_alias, alias, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_widget_type_using_get(is_system, bundle_alias, alias, callback=callback_function)
    ...
    def get_widget_type_using_get_with_http_info(self, is_system, bundle_alias, alias, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_widget_type_using_get_with_http_info(is_system, bundle_alias, alias, callback=callback_function)
        ...
        resource_path = '/api/widgetType'.replace('{format}', 'json')
        path_params = {}
    ...
    def save_widget_type_using_post(self, widget_type, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.save_widget_type_using_post(widget_type, callback=callback_function)
    ...
    def save_widget_type_using_post_with_http_info(self, widget_type, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.save_widget_type_using_post_with_http_info(widget_type, callback=callback_function)

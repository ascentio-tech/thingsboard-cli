...
class EventcontrollerApi(object):
    ...
    def get_events_using_get(self, entity_type, entity_id, event_type, tenant_id, limit, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_events_using_get(entity_type, entity_id, event_type, tenant_id, limit, callback=callback_function)
    ...
    def get_events_using_get_with_http_info(self, entity_type, entity_id, event_type, tenant_id, limit, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_events_using_get_with_http_info(entity_type, entity_id, event_type, tenant_id, limit, callback=callback_function)
        ...
        resource_path = '/api/events/{entityType}/{entityId}/{eventType}'.replace('{format}', 'json')
        path_params = {}
    ...
    def get_events_using_get1(self, entity_type, entity_id, tenant_id, limit, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_events_using_get1(entity_type, entity_id, tenant_id, limit, callback=callback_function)
    ...
    def get_events_using_get1_with_http_info(self, entity_type, entity_id, tenant_id, limit, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_events_using_get1_with_http_info(entity_type, entity_id, tenant_id, limit, callback=callback_function)
        ...
        resource_path = '/api/events/{entityType}/{entityId}'.replace('{format}', 'json')
        path_params = {}
        if 'entity_type' in params:
            path_params['entityType'] = params['entity_type']
        if 'entity_id' in params:

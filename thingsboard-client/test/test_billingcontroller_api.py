...
from thingsboard_client.apis.billingcontroller_api import BillingcontrollerApi
...
class TestBillingcontrollerApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = thingsboard_client.apis.billingcontroller_api.BillingcontrollerApi()

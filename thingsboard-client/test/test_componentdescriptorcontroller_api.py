...
from thingsboard_client.apis.componentdescriptorcontroller_api import ComponentdescriptorcontrollerApi
...
class TestComponentdescriptorcontrollerApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = thingsboard_client.apis.componentdescriptorcontroller_api.ComponentdescriptorcontrollerApi()

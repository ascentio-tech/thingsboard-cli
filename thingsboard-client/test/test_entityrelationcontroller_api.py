...
from thingsboard_client.apis.entityrelationcontroller_api import EntityrelationcontrollerApi
...
class TestEntityrelationcontrollerApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = thingsboard_client.apis.entityrelationcontroller_api.EntityrelationcontrollerApi()

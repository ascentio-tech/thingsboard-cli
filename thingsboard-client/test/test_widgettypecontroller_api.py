...
from thingsboard_client.apis.widgettypecontroller_api import WidgettypecontrollerApi
...
class TestWidgettypecontrollerApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = thingsboard_client.apis.widgettypecontroller_api.WidgettypecontrollerApi()
